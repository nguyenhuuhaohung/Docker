                    ...
                    <?php foreach ($users as $user) { ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <form method="POST" action="delete_user.php" style="display:inline" onsubmit="return confirm('Bạn có chắc muốn xóa user này?');">
...
<div class="card" style="margin-top:30px; padding:16px; border:1px solid #eee; background:#fafafa;">
  ...
  <select id="test-user-id" style="margin:6px 0 12px 0;">
    <?php foreach ($users as $u): ?>
      <option value="<?php echo htmlspecialchars($u['id']); ?>"><?php echo htmlspecialchars($u['id'].' — '.$u['name']); ?></option>
    <?php endforeach; ?>
  </select>
  ...
  <div id="csrf-test-log" style="white-space:pre-wrap; background:#fff; padding:10px; border:1px solid #ddd; min-height:60px;"></div>
